  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <form onSubmit={seConnecter} className="card p-8 w-full flex flex-col gap-5">
          <div>
            <h1 className="font-display font-bold text-3xl">Connexion</h1>
            <p className="text-sm text-ink/50 mt-1">Connecte-toi à Hill Solution.</p>
          </div>
          ...
          <button type="submit" disabled={chargement} className="btn-primary disabled:opacity-50 w-full">
