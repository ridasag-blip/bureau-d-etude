    ...
    <div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="card p-6 mb-6 flex flex-col md:flex-row gap-6">
          <div className="flex flex-col items-center justify-center gap-2 md:w-56 shrink-0 md:border-r border-black/5 md:pr-6">
            <img src="/logo-hillsolution.png" alt="Hill Solution" className="h-24 w-auto" />
          </div>
        ...
        {/* 4. Ligne date/horloge à gauche + actions à droite */}
