...
-- Objectif journalier optionnel (utilisé seulement les jours où la Qualité
-- veut répartir un volume précis — sinon "Mes dossiers" affiche juste un
-- compteur simple sans cible)
