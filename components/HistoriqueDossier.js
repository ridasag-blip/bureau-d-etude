...
const LABELS = {
  ...
  retour_interne_avant_audit: { texte: "Retour interne (avant audit)", couleur: "#FFB800" },
  retour_interne_apres_audit: { texte: "Retour interne (après audit)", couleur: "#FF2D3A" },
  retour_client: { texte: "Retour client (modif. demandée)", couleur: "#FF2D3A" },
