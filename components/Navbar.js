    ...
    <header className="border-b border-black/5 bg-white sticky top-0 z-20">
      <div className="max-w-7xl mx-auto px-6 flex items-center h-16 gap-8">
        <div className="flex items-center gap-2 font-display font-bold text-lg">
          <img src="/logo-hillsolution.png" alt="Hill Solution" className="h-9 w-auto" />
          <span>Hill Solution <span className="text-isoGreen">Qualité</span></span>
        </div>
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          {role === "ingenieur" && onChangerPersonne && (
