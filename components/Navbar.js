    ...
    <>
      {["admin", "qualite"].includes(role) && (
        <img
          ...
          alt="Hill Solution"
          className="hidden xl:block fixed top-[104px] left-6 w-56 z-0"
        />
      )}
      <header className="border-b border-black/5 bg-white sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-6 flex items-center h-20 gap-8">
          {!masquerHorloge && (
          ...
          <div className="flex items-center shrink-0">
            <img src="/logo-hillsolution.png" alt="Hill Solution" className="h-40 w-auto shrink-0" />
          </div>
