...
export default function Navbar({ role, nom, onChangerPersonne }) {
    ...
    <>
      ...
      <header className="border-b border-black/5 bg-white sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-6 flex items-center h-24 gap-8">
          <div className="flex items-center gap-3 font-display font-bold text-lg shrink-0">
            <img src="/logo-hillsolution.png" alt="Hill Solution" className="h-16 w-auto shrink-0" />
            <span className="whitespace-nowrap">Hill Solution</span>
          </div>
