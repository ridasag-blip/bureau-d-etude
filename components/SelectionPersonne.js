  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        <img src="/logo-hillsolution.png" alt="Hill Solution" className="h-20 w-auto" />

        <form onSubmit={valider} className="card p-8 w-full flex flex-col gap-5">
          <div>
            <h1 className="font-display font-bold text-3xl">Qui es-tu ?</h1>
            <p className="text-sm text-ink/50 mt-1">{sousTitre}</p>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              required
              className="border rounded-xl px-4 py-2.5 text-sm bg-isoGreen-light/40 border-transparent focus:bg-white focus:border-isoGreen"
              value={nomChoisi}
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              maxLength={6}
              required
              className="border rounded-xl px-4 py-2.5 text-sm tracking-widest text-center bg-isoGreen-light/40 border-transparent focus:bg-white focus:border-isoGreen"
              value={pin}
